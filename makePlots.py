...
def make_SplinePlot():
    ...
    try:
            ...
            X,Y, X_izq, X_der, Y_arr, Y_aba = loadtxt('ATOM1.dat', unpack = True)
            X1,Y1, X1_izq, X1_der, Y1_arr, Y1_aba = loadtxt('HESS1.dat', unpack = True)
            X2,Y2, X2_izq, X2_der, Y2_arr, Y2_aba = loadtxt('LAT1.dat', unpack = True)
            X3,Y3, X3_izq, X3_der, Y3_arr, Y3_aba = loadtxt('NED1.dat', unpack = True)
            X4,Y4, X4_izq, X4_der, Y4_arr, Y4_aba = loadtxt('UVOT1.dat', unpack = True)
            X5,Y5, X5_izq, X5_der, Y5_arr, Y5_aba = loadtxt('XRT1.dat', unpack = True)
...
files = ['ATOM1.dat', 'HESS1.dat', 'LAT1.dat', 'NED1.dat', 'UVOT1.dat', 'XRT1.dat']
