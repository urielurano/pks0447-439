...
def make_SplinePlot():
    ...
    try:
            ...
            X1,Y1, X1_izq, X1_der, Y1_arr, Y1_aba = loadtxt('atom.dat', unpack = True)
            X2,Y2, X2_izq, X2_der, Y2_arr, Y2_aba = loadtxt('fermi.dat', unpack = True)
            X3,Y3, X3_izq, X3_der, Y3_arr, Y3_aba = loadtxt('hess.dat', unpack = True)
            X4,Y4, X4_izq, X4_der, Y4_arr, Y4_aba = loadtxt('ned.dat', unpack = True)
            X5,Y5, X5_izq, X5_der, Y5_arr, Y5_aba = loadtxt('uvot.dat', unpack = True)
            X6,Y6, X6_izq, X6_der, Y6_arr, Y6_aba= loadtxt('xrt.dat', unpack = True)
